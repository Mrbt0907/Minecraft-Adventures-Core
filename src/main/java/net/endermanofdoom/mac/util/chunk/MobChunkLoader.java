package net.endermanofdoom.mac.util.chunk;
...
public class MobChunkLoader implements LoadingCallback{
	...
	public static void init()
	{
		...
		ForgeChunkManager.setForcedChunkLoadingCallback(MACCore.instance, instance);
	}
	...
	public static void updateLoaded(Entity mob)
	{
		...
		ticket = ForgeChunkManager.requestTicket(MACCore.instance, mob.world, ForgeChunkManager.Type.ENTITY);
