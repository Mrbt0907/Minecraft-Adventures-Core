...
public abstract class AbstractBlockRegistry
{
	...
	{
		MACCore.debug("Registering blocks for mod " + MODID + "...");
	...
	public void addBlock(String registryName, String oreDictName, Block block, CreativeTabs creativeTab)
	{
		...
		MACCore.debug("Registered block " + block.getRegistryName().getResourceDomain() + ":" + block.getRegistryName().getResourcePath());
	}
}
