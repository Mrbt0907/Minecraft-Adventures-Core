...
public class GuiBossBarHud extends Gui
{
	...
	public GuiBossBarHud(Minecraft mc)
	{
		this.mc = mc;
	}
	...
	{	
		...
		{
			MACCore.debug("Removing Entry " + uuid + "...");
			entries.remove(uuid);
		}
		...
		if (mc.world != null)
		{
			...
			{
				if (entity instanceof IBossBars && !entries.containsKey(entity.getUniqueID()))
					entries.put(entity.getUniqueID(), new GuiEntry((IBossBars) entity));
			});
		}
