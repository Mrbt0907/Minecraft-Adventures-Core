...
import net.endermanofdoom.mac.util.ColorUtils;
...
public class GuiDialogue extends AbstractGui
{
	...
	{
		MACCore.debug("Displaying new sub dialogue message (" + SUBDIALOGUE.size() + ")");
	...
	{
		MACCore.debug("Forcing a new sub dialogue message (" + SUBDIALOGUE.size() + ")");
		reset();
